...
df %>% 
  ...
  ggplot() + geom_point(aes(x=dayslink, y=mh_index, color=group)) + facet_grid(vars(attempted_suicide), vars(linkstatus)) 
...
df %>% 
  ...
  ggplot() + geom_point(aes(x=dayslink, y=num_med_problems, color=group)) + facet_grid(vars(linkstatus)) + ggtitle("Number of Medical Problems by Days Separated by Success")
