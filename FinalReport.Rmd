...
in the introduction: have you gotten a chance to play around much with the other variables (not the treatment or response)?  Ideally you can make a bunch of plots just to have a sense of the dataset.  How are the variables coded?  What do you do with factor variables?  Lots of missingness…  what should be done about that?  Which variables are most interesting?
