...
The weird samlping method treats each death time as independent binomial variables. Each bionomal variable as a probability of $\frac{d_j}{n-j+1}$ probability of dying (DAvison et al.)  
